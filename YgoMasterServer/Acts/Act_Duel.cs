        ...
        DuelSettings CreateSoloDuelSettingsInstance(Player player, int chapterId)
        {
            ...
            if (ds != null)
            {
                ...
                if (IsMysteryDuelChapter(duelSettings.chapter))
                {
                    ...
                    List<KeyValuePair<int, DuelSettings>> cpuDeckChapters = IsMysteryCampaignChapter(duelSettings.chapter) ? leCampaignChapter : leDuelistChallengeChapter;
                    DuelSettings playerDuelSettings = leCampaignChapter.ElementAt(rand.Next(leCampaignChapter.Count)).Value;
                    DuelSettings cpuDuelSettings = cpuDeckChapters.ElementAt(rand.Next(cpuDeckChapters.Count)).Value;
